...
<section class="home-section">
    ...
    <div class="home-content">
        ...
        <div class="main-content">
            ...
            <h1>Update Emergency Contact Name</h1>

            <div class="content">

            <form action="" method="POST">
                
                <label for="Emergency Name"><b>Emergency Contact Name</b></label><br>
                <input type="text" placeholder="Enter Emergency Contact Name" name="emname" required><br>
