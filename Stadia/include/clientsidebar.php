    ...
    <div class="nav-links">
        <a href="dashboard.php"><i class="fa fa-th-large" ></i><span class="links_name">Dashboard</span></a>
        ...
        <a href="clientviewcomplaints.php"><i class="fa fa-comments" ></i><span class="links_name">Complaints</span></a>
