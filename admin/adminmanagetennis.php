                ...
                <div class="form">
                    ...
                    <div class="detailsright">
                        ...
                        <div class="button">
                            ...
                            <input type="submit" name="Delete Slot" value="Delete Slot" class="btn2">
                        </div>
                        </form>
                    </div>
                </div>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <div class="main-content">
                ...
                <div class="form">
                    <h1>Add Slot - Tennis</h1>
                    <div class="detailsleft-main">
                        <div class="detailsleft">
                            <form name="form1" method="post" action="adminmanagetennis.php">
