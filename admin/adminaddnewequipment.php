...
//   $ItemId = $_POST['ItemId'];
  ...
  $sql = "INSERT INTO adminaddequipment ( Itemname, Quantity) VALUES ('$Itemname','$Quantity')";
  ...
  if ($rs) {
    ...
    //header("location : viewequipment.php");
    echo "<script>window.location.href='http://localhost/Stadia/admin/adminviewequipment.php'; </script>";
