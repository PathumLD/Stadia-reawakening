                ...
                <div class="form">
                    ...
                    <div class="detailsleft-main">
                        ...
                        <div class="detailsleft">
                            ...
                            <input class="radio" type="radio" name="court" value="court1">
                            <label for="court">Court 1</label>
                            <input class="radio" type="radio" name="court" value="court2">
                            <label for="court">Court 2</label>
                        </div>
                    </div>
...
if(isset($_POST['add_slot'])) {
    ...
    // insert the slot information into the database
    ...
    // check if the slot was added successfully
    // if($result && !isset($_SESSION['alertDisplayed'])) {
    //     echo "<script>alert('Slot added successfully.');</script>";
    //     $_SESSION['alertDisplayed'] = true;
    // } else if (!$result && !isset($_SESSION['alertDisplayed'])) {
    //     echo "<script>alert('Error adding slot.');</script>";
    //     $_SESSION['alertDisplayed'] = true;
    // }

    header('Location://http://localhost/stadia/admin/adminmanagebadminton.php');
}
?>
