...
$query = "SELECT itemname, quantity FROM refreshments";
    ...
    <section class="home-section">
        ...
        <div class="left-box">
            <div class=" title">Equipment Summary
                ...
                echo "<p> for $currentDate</p>"; ?><canvas id="myChart"
            ...
            <!-- Display the chart using the retrieved data -->
            <!-- <script>
            ...
            <div class=" title">Refreshment Summary<canvas id="myChart2" style="width:100%;height:80%"></canvas>
            </div>
