             ...
             <!-- HTML form to upload the image -->
              ...
              <div class="profiledata">
                ...
                <?php
                  ...
                  if(isset($_GET['msg3']) && $_GET['msg3'] == 'error') {
                    echo "<div id='notsuccess-msg3' class='notsuccess-message'>Only letters and space allowed in name.</div>";
                  }
                ?>
                ...
                <div class="cv">
                    ...
                    <div class="cv-form">
                      ...
                      <?php
                          ...
                          //retrieve the pdf in a new page
                          // $folder = "../pdf/";
                          // $sql = "SELECT * FROM pdf_data WHERE email = '".$var."' ";
                          // $result = mysqli_query($linkDB, $sql);
                          // $row = mysqli_fetch_array($result);
                          ...
                          //   echo '<a href="'.$folder.$file_id.$filename.'" target="_blank">Open CV</a>';
                          // } else {
                          //   echo "CV not found for the given email.";
                          // }
                      ?>
...
<div id="popup3" class="popup3">
  <div class="popup-content">
    ...
    <h3>Change Emergency Contact Name</h3>
    <form method="post" action="updateprofile.php" >
