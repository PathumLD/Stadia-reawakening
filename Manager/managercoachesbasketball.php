...
<section class="home-section">
    ...
    if(isset($_SESSION['email'])) {
        ...
        if($search == 'all') {
            $query = "SELECT * FROM coach_classes WHERE sport='basketball' AND (status = '1' OR status = '2')";
        } else {
            $query = "SELECT * FROM coach_classes WHERE coach LIKE '%$search%' AND sport='basketball' AND (status = '1' OR status = '2')";
        }
