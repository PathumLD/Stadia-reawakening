                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<tr id='row_$id'>
                                            ...
                                            <td><button class='update-button' onclick=\"openPopup($id)\"><i class='fa fa-check'></i></button></td>
                                    </tr>";
                                }
                            } else {
...
if (isset($_POST['verify-d'])) {
    ...
    if($rs){
    echo "<script>window.location.href='managerclassverification.php'; </script>";
    }
}
?>
                        </table>
